...
wind();
var gal = document.getElementById("galleryMain");
fetch('gallery.json').then(function (response) {
  ...
  var phot = document.getElementsByClassName("photo");

  var _loop = function _loop(_i) {
    phot[_i].addEventListener("click", function () {
      openPicture(phot, _i);
    });
  };

  for (var _i = 0; _i < phot.length; _i++) {
    _loop(_i);
  }
});
var open = false;
